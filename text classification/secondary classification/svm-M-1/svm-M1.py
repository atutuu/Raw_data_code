...
print ('(1) load texts...')
train_texts = open('1-递送速度-1500.txt',encoding='gb18030').read().split('\n')
train_labels = open('1-递送速度-L1500.txt',encoding='gb18030').read().split('\n')
test_texts = open('1-递送速度-500.txt',encoding='gb18030').read().split('\n')
test_labels = open('1-递送速度-L500.txt',encoding='gb18030').read().split('\n')
